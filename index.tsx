...
const EFFECTS_LIBRARY = [
  ...
  { id: "effect_59", name: "Effect 59", desc: "In this vibrant photograph, a young girl beams with delight as she strolls through a festive scene. She is the epitome of innocence and happiness, her colorful patterned dress matching the joyous atmosphere created by the myriad of balloons and confetti around her. The balloons in the background add a sense of celebration, and the confetti on the ground paints the scene with splashes of color. The blurred background focuses all attention on the child, making her the undeniable subject of this moment captured in time.", isPro: true, icon: "fa-solid fa-image", color: "from-purple-500 to-pink-500" },
  { id: "effect_60", name: "Effect 60", desc: "A delightful portrait of a cheerful young girl enjoying the essence of summer. Her radiant smile complements the vibrant sunflower adorned in her hair, as she holds a tantalizing ice cream cone, anticipating the sweet taste. The sun's soft glow emphasizes her joyful expression, making for a captivating image that exudes warmth and happiness. It's a moment that captures the innocence and simple pleasures of childhood.", isPro: true, icon: "fa-solid fa-image", color: "from-purple-500 to-pink-500" },
  { id: "effect_61", name: "Effect 61", desc: "Captured in a moment of youthful innocence, this young girl, clad in a pristine white dress adorned with delicate lace and a crown of fresh flowers, gazes upward with a look of wonderment. She gracefully clutches an ornate book, possibly a hymnal or a book of prayers, standing poised inside a place of worship. The soft, diffused light pouring through the stained glass window bathes her in a kaleidoscope of colors, accentuating the ethereal beauty of this touching scene.", isPro: true, icon: "fa-solid fa-image", color: "from-purple-500 to-pink-500" },
  { id: "effect_62", name: "Effect 62", desc: "Captured in the midst of a joyous cultural festival, this young girl stands out in her colorful traditional dress, embellished with bright patterns and intricate designs. She appears to be singing with gusto, her eyes slightly closed and her mouth wide open, indicating a powerful moment of vocal expression. In the blurred background, it's apparent that she is not alone, as other children can be seen in the festivities, which hints at a communal celebration where tradition and youthful exuberance intertwine.", isPro: true, icon: "fa-solid fa-image", color: "from-purple-500 to-pink-500" },
  { id: "effect_63", name: "Effect 63", desc: "In the warming glow of a sunny day, a young girl with a gleaming smile stands holding a wicker basket full of large, luscious strawberries. Her eyes sparkle with delight, reflecting a moment of pure joy and the satisfaction of a fruitful harvest. The deep red berries contrast beautifully with the girl's crisp white shirt and patterned pink skirt, creating a picture-perfect moment of summer bliss.", isPro: true, icon: "fa-solid fa-image", color: "from-purple-500 to-pink-500" },
  ...
  { id: "effect_87", name: "Effect 87", desc: "Captured in the golden glow of sunlight, an exuberant young girl with flowing hair is seen frolicking through a vibrant field filled with yellow blooms. Her laughter seems almost audible as she moves with unrestrained joy, her charming floral dress billowing around her. This image encapsulates the essence of carefree childhood, with the natural landscape providing a picturesque backdrop for a moment of pure bliss and freedom.", isPro: true, icon: "fa-solid fa-image", color: "from-purple-500 to-pink-500" },
  { id: "effect_88", name: "Effect 88", desc: "In the midst of nature's own canvas, a young girl becomes the embodiment of joy and freedom as she leaps high above a sea of blooming flowers. The sky above is a brilliant blue, dotted with the soft whispers of white clouds, while the sun beams down, enveloping her in a warm glow. This moment captures the very essence of childhood – carefree, spirited, and full of life.", isPro: true, icon: "fa-solid fa-image", color: "from-purple-500 to-pink-500" },
  ...
  { id: "effect_90", name: "Effect 90", desc: "Captured in mid-air, this image showcases the exuberance of a young girl as she leaps with wild abandon among a field of colorful wildflowers. Her yellow dress matches the sunny atmosphere provided by the bright blue sky and radiant sun shining down. The picture is a celebration of childhood, nature, and the carefree spirit that comes with warm summer days spent outdoors.", isPro: true, icon: "fa-solid fa-image", color: "from-purple-500 to-pink-500" }
];
